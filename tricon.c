...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/02 16:47:54 by pdursley          #+#    #+#             */
/*   Updated: 2022/02/02 16:47:57 by pdursley         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fractol.h"

int	tricon_mth(t_complex *comp)
{
	int	iteration;
...
void	ft_draw_tric(t_complex *comp, t_color *col)
{
	comp->iteration = tricon_mth(comp);
